...
Stop the scheduler, reset all four portfolios, and restart it:
...
Resetting restores the original strategies and $10,000 balances while removing all holdings, transactions, and portfolio history.
