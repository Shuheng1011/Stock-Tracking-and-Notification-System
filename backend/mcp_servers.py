...
# The built-in market server exposes live Massive prices without downloading and
# starting a Git-hosted MCP package at runtime.
market_params = {
    "command": "uv",
...
def trader_mcp_servers() -> list[MCPServerStdio]:
    """The trader's MCP servers: account management and market data."""
    params = [
